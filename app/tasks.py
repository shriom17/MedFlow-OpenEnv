...
TASK_EASY = TaskConfig(
    ...
    initial_patients=[
        ...
        dict(id=6, name="Rahul Das",    age=31, priority="normal",    condition="migraine",    severity_score=3,   required_specialization="General",   arrival_minute=0),
        dict(id=7, name="Ananya Roy",   age=52, priority="urgent",    condition="chest discomfort",  severity_score=8,  required_specialization="General",  arrival_minute=0),
        dict(id=8, name="Debasis Mondal", age=65, priority="emergency",  condition="respiratory distress",  severity_score=10,  required_specialization="General", arrival_minute=0),
    ],
    doctors=[
